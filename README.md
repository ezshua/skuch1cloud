...
- `LOG_FILE_SIZE_LIMIT` — лимит размера файла журнала действий в байтах (по умолчанию: `1048576`, то есть 1 МБ). При превышении лимита бот удаляет часть старых записей.
